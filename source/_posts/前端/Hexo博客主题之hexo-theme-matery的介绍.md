---
title: Hexo博客主题之hexo-theme-next的介绍
...
点击 [这里](https://codeload.github.com/blinkfox/hexo-theme-next/zip/master) 下载 `master` 分支的最新稳定版的代码，解压缩后，将 `hexo-theme-next` 的文件夹复制到你 Hexo 的 `themes` 文件夹中即可。

当然你也可以在你的 `themes` 文件夹下使用 `Git clone` 命令来下载:

```bash
git clone https://github.com/blinkfox/hexo-theme-next.git
```
...
修改 Hexo 根目录下的 `_config.yml` 的  `theme` 的值：`theme: hexo-theme-next`
...
![首页](http://static.blinkfox.com/next-20181202-1.png)

![首页推荐文章](http://static.blinkfox.com/next-20181202-2.png)

![首页文章列表](http://static.blinkfox.com/next-20181202-3.png)

![首页文章列表](http://static.blinkfox.com/next-20181202-7.png)

![首页文章列表](http://static.blinkfox.com/next-20181202-8.png)
...
在主题文件的 `/source/css/next.css` 文件中，搜索 `.bg-color` 来修改背景颜色：
